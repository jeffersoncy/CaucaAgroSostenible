...
public class GlobalDefaultExceptionHandler {
	...
	/**
	 * Método para manejar la excepcion CarritoDomainException
	 * 
	 * @param e PlatoDomainException
	 * @return la excepción en formato Json
	 */
	@ExceptionHandler(EventosDomainException.class)
	@RequestMapping(produces = "application/json")
	@ResponseBody
	public ResponseEntity<ErrorsPayload> handleTodoDomainException(EventosDomainException e) {
